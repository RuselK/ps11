(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7ecae7._.js", {
...
;
;
// Динамически импортируем ReactQuill, чтобы не рендерить его на сервере (SSR)
const ReactQuill = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_require__("[project]/node_modules/react-quill/lib/index.js [app-client] (ecmascript, async loader)")(__turbopack_import__), {
    loadableGenerated: {
        modules: [
            "app/dashboard/page.tsx -> " + "react-quill"
        ]
    },
    ssr: false
});
...
function PostEditor() {
    _s();
    const [editorHtml, setEditorHtml] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    // Функция для загрузки изображения на бэкенд
    ...
    // Кастомный обработчик кнопки вставки изображения в тулбаре редактора
    const imageHandler = ()=>{
    ...
    // Конфигурация редактора с кастомным обработчиком для кнопки "image"
    const modules = {
        toolbar: {
            container: [
                [
    ...
    // Функция отправки поста на бэкенд
...
_s(PostEditor, "RTwZCk2YWyL/JFLOS4PHXUh/Wy8=");
_c1 = PostEditor;
var _c, _c1;
__turbopack_refresh__.register(_c, "ReactQuill");
__turbopack_refresh__.register(_c1, "PostEditor");
...
//# sourceMappingURL=_7ecae7._.js.map